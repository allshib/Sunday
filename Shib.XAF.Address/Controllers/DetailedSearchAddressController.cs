...
namespace Shib.XAF.Address.Controllers
{
    ...
    public partial class DetailedSearchAddressController : ViewController
    {
        private readonly IAddressSearcher addressSearcher;
        public DetailedSearchAddressController()
        {
            InitializeComponent();
        ...
        public DetailedSearchAddressController(IAddressSearcher addressSearcher) : this()
        {
        ...
        private void SearchAddress_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            var addresses = addressSearcher.GetAddressList(picker.SearchString);
